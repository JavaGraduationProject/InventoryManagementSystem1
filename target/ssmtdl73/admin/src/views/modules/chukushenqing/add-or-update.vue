          ...
          <el-form-item class="input" label="账号" prop="zhanghao">
              <el-input v-model="ruleForm.zhanghao" 
                placeholder="账号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商家" prop="shangjia">
          <el-input v-model="ruleForm.shangjia" 
              placeholder="商家" clearable  :readonly="ro.shangjia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商家" prop="shangjia">
              <el-input v-model="ruleForm.shangjia" 
                placeholder="商家" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="商品类型" prop="shangpinleixing">
              <el-input v-model="ruleForm.shangpinleixing" 
                placeholder="商品类型" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商品数量" prop="shangpinshuliang">
          <el-input v-model="ruleForm.shangpinshuliang" 
              placeholder="商品数量" clearable  :readonly="ro.shangpinshuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商品数量" prop="shangpinshuliang">
              <el-input v-model="ruleForm.shangpinshuliang" 
                placeholder="商品数量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出库数量" prop="chukushuliang">
          <el-input v-model="ruleForm.chukushuliang" 
              placeholder="出库数量" clearable  :readonly="ro.chukushuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="出库数量" prop="chukushuliang">
              <el-input v-model="ruleForm.chukushuliang" 
                placeholder="出库数量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhanghao = true;
            continue;
	            	            ...
	            	            if(o=='shangjia'){
            this.ruleForm.shangjia = obj[o];
	    this.ro.shangjia = true;
            continue;
          }
	    ...
	    this.ro.shangpinshuliang = true;
            continue;
	            	            ...
	            	            if(o=='chukushuliang'){
            this.ruleForm.chukushuliang = obj[o];
	    this.ro.chukushuliang = true;
            continue;
          }
    ...
    onSubmit() {
                  // ${column.compare}
                              ...
                              // ${column.compare}
                              // ${column.compare}
                                                                                                                  if(this.ruleForm.chukushuliang>this.ruleForm.shangpinshuliang){
        this.$message.error("出库数量不能超过商品数量");
        return
      }
                                                                                                                  this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `chukushenqing/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.chukushenqingCrossAddOrUpdateFlag = false;
                  this.parent.search();
