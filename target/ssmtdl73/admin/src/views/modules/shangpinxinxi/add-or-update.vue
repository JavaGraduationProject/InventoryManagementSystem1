          ...
          <el-form-item class="input" label="商品规格" prop="shangpinguige">
              <el-input v-model="ruleForm.shangpinguige" 
                placeholder="商品规格" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="商品数量" prop="shangpinshuliang">
          <el-select v-model="ruleForm.shangpinshuliang" placeholder="请选择商品数量">
            <el-option
                v-for="(item,index) in shangpinshuliangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        if (data && data.code === 0) {
          var json = data.data;
              		...
              		this.ruleForm.zhanghao = json.zhanghao
                                  		...
                                  		if(json.shangjia!=''&&json.shangjia){
              		this.ruleForm.shangjia = json.shangjia
		}
                                                                                                                                            } else {
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                                                            ...
                                                                            this.shangpinshuliangOptions = "0".split(',')
                            },
                                                                // 多级联动参数
                                                                                  info(id) {
      this.$http({
